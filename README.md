...
最近每天活都很满人也累，但还是想试试做点什么。于是在这个深夜打开 Google AI Studio，写了一个可以给朋友点帮助的小工具。测试时把最近几年的一些经历和零碎的想法抽象成一句简单的描述交给了它，让它依次生成故事。

故事很短，和描述一样简单。但眼前的小故事配合着那可爱到笨蛋的小助手却像有一种催人泪下的魔力。

我之前总觉得 AI 陪伴这件事不靠谱，后来觉得做一个设计精妙的系统，准确送给 AI 合适的数据，陪伴就会发生。
...
如果可以的话，我想和一些志同道合的人，各自把想做的东西做出来，然后互相分享、讨论、激发灵感。不需要很多人，也不需要很正式，只是希望能有个松散的、有趣的小圈子。大家一起也许将来还能一起做点更有趣的事。
